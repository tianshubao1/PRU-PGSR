...
for i in range (0, index):
    ...
    u_input = np.load('sj_recon/u/u_' + str(71 + i*stepsize) + '.npy')  #71, 76, 81 ...
    v_input = np.load('sj_recon/v/v_' + str(71 + i*stepsize) + '.npy')
    w_input = np.load('sj_recon/w/w_' + str(71 + i*stepsize) + '.npy')
    ...
    np.save('./pru recon pred/' + str(stepsize - 1) + '/u' + curr +'.npy', u_input)
    np.save('./pru recon pred/' + str(stepsize - 1) + '/v' + curr +'.npy', v_input)
    np.save('./pru recon pred/' + str(stepsize - 1) + '/w' + curr +'.npy', w_input)
    ...
    np.save('./pru recon pred/' + str(stepsize - 1) + '/u' + curr +'.npy', u_pred)
    np.save('./pru recon pred/' + str(stepsize - 1) + '/v' + curr +'.npy', v_pred)
    np.save('./pru recon pred/' + str(stepsize - 1) + '/w' + curr +'.npy', w_pred)

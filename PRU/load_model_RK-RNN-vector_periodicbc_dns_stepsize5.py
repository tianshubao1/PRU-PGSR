...
stepsize = 5 + 1
index = int(50/stepsize)


for i in range (0, index):

    u_input = np.load('img_u_dns' + str(71 + i*stepsize) + '.npy')      #71, 77, 83 ...
    ...
    np.save('./pru dns pred/5/u' + curr +'.npy', u_input)
    np.save('./pru dns pred/5/v' + curr +'.npy', v_input)
    np.save('./pru dns pred/5/w' + curr +'.npy', w_input)
